...
def initiate():
    ...
    car_model_data = [
      {"name":"Pathfinder", "type":"SUV", "year": 2026, "car_make":car_make_instances[0]},
      {"name":"Qashqai", "type":"SUV", "year": 2024, "car_make":car_make_instances[0]},
      {"name":"XTRAIL", "type":"SUV", "year": 2022, "car_make":car_make_instances[0]},
      {"name":"A-Class", "type":"SUV", "year": 2020, "car_make":car_make_instances[1]},
